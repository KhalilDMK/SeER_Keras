from keras.layers import Embedding, Input, Flatten, LSTM, Reshape, dot, Dropout, GRU, SimpleRNN, concatenate, Dense
...
def get_model(num_users, num_songs, num_latent_features, midi_array, num_channels, sequence_length):
    ...
    LSTM_1 = LSTM(num_latent_features, name='LSTM_1', dropout=0.2, recurrent_dropout=0.2)(song_feature_input)
    #dropout_1 = Dropout(0.2)(LSTM_1)
    concat = concatenate([user_latent, LSTM_1])
...
def get_explainability_model(num_users, num_latent_features, num_channels, model_name):
    ...
    LSTM_1 = LSTM(num_latent_features, name='LSTM_1', dropout=0.2, recurrent_dropout=0.2)(song_array_input)
    #dropout_1 = Dropout(0.2)(LSTM_1)
    concat = concatenate([user_latent, LSTM_1])
    prediction = Dense(1)(concat)
